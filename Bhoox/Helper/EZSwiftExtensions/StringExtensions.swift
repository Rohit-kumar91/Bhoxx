...
extension String {
    ...
    /// EZSE: Uppercases first 'count' self of String, returns a new string
    ...
    /// EZSE: Uppercases last 'count' chracter of String
    ...
    /// EZSE: Lowercases first 'count' self of String
    ...
    /// EZSE: Lowercases first 'count' character of String, returns a new string
    ...
    public func underlineWithColor(color : UIColor) -> NSAttributedString {
        let underlineString = NSAttributedString(string: self, attributes: [NSAttributedString.Key.underlineStyle: NSUnderlineStyle.single.rawValue , NSAttributedString.Key.foregroundColor : color ])
        return underlineString
    }
